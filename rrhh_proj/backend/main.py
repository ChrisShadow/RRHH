...
def main():
    try:
        ...
        lugar_trabajo1=LugarTrabajo.create_from_string(lugar_trabajo1_data_string)
        ...
        lugar_trabajo2=LugarTrabajo.create_from_string(lugar_trabajo2_data_string)
        ...
        lugar_trabajo3=LugarTrabajo.create_from_string(lugar_trabajo3_data_string)

        lugar_trabajo4_data_string="Coseres SA,General Elizardo Aquin-Ruta vieja,Luque,Edificio Kemsa"
        lugar_trabajo4=LugarTrabajo.create_from_string(lugar_trabajo4_data_string)

        lugar_trabajo5_data_string="Ion Monitor,Avd Molas Lopez,Asuncion,Edificio Plaza Real"
        lugar_trabajo5=LugarTrabajo.create_from_string(lugar_trabajo5_data_string)
        #endregion
